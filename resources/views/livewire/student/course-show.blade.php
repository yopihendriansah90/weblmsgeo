                            ...
                            <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @if($isQuiz)
                                        ...
                                        @elseif($item['href'])
                                            <a class="inline-flex items-center justify-center rounded-full bg-[#c84a2f] px-4 py-2.5 text-sm font-medium text-white shadow-sm shadow-[#c84a2f]/20 transition hover:bg-[#a93b25]" href="{{ $item['href'] }}">
                                                Buka Quiz
                                            </a>
                                        @elseif($item['is_completed'])
                                            <span class="inline-flex items-center justify-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2.5 text-sm font-medium text-emerald-700">
